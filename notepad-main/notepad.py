...
class MainWindow(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Tambahkan label identitas mahasiswa (tidak bisa diedit)
        student_info = QLabel("Nama: Kalsum Rahmawati | NIM: F1D022126")
        student_info.setStyleSheet("color: gray; font-weight: bold;")
        self.status.addPermanentWidget(student_info)
